...
const ServicesSection = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={isMobile ? "absolute top-1/4 left-1/4 w-32 h-32 bg-[#E8E4D9]/35 rounded-full blur-2xl" : "absolute top-1/4 left-1/4 w-32 h-32 bg-[#E8E4D9]/35 rounded-full blur-3xl"}
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      />
      <motion.div
        className={isMobile ? "absolute bottom-1/4 right-1/4 w-24 h-24 bg-softtail-400/8 rounded-full blur-xl" : "absolute bottom-1/4 right-1/4 w-24 h-24 bg-softtail-400/8 rounded-full blur-2xl"}
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.5, 0.2],
        }}
      ...
      />
      <motion.div
        className={isMobile ? "absolute top-1/2 right-1/3 w-20 h-20 bg-softtail-400/6 rounded-full blur-lg" : "absolute top-1/2 right-1/3 w-20 h-20 bg-softtail-400/6 rounded-full blur-2xl"}
        animate={{
          scale: [1, 1.1, 1],
          opacity: [0.4, 0.7, 0.4],
        }}
