...
const ValuesSection = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={isMobile ? "absolute top-1/4 left-1/4 w-40 h-40 bg-[#E8E4D9]/25 rounded-full blur-3xl" : "absolute top-1/4 left-1/4 w-40 h-40 bg-[#E8E4D9]/25 rounded-full blur-3xl"}
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      />
      <motion.div
        className={isMobile ? "absolute bottom-1/4 right-1/4 w-32 h-32 bg-softtail-400/10 rounded-full blur-2xl" : "absolute bottom-1/4 right-1/4 w-32 h-32 bg-softtail-400/10 rounded-full blur-2xl"}
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.5, 0.2],
        }}
      ...
      />
      <motion.div
        className={isMobile ? "absolute top-1/2 left-1/2 w-24 h-24 bg-[#E8E4D9]/20 rounded-full blur-xl" : "absolute top-1/2 left-1/2 w-24 h-24 bg-[#E8E4D9]/20 rounded-full blur-xl"}
        animate={{
          scale: [1, 1.1, 1],
          opacity: [0.4, 0.7, 0.4],
        }}
