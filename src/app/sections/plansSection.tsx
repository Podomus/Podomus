...
const PlansSection = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={isMobile ? "absolute top-1/4 right-1/4 w-36 h-36 bg-[#E8E4D9]/30 rounded-full blur" : "absolute top-1/4 right-1/4 w-36 h-36 bg-[#E8E4D9]/30 rounded-full blur-3xl"}
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      />
      <motion.div
        className={isMobile ? "absolute bottom-1/4 left-1/4 w-28 h-28 bg-softtail-400/12 rounded-full blur" : "absolute bottom-1/4 left-1/4 w-28 h-28 bg-softtail-400/12 rounded-full blur-2xl"}
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.5, 0.2],
        }}
      ...
      />
      <motion.div
        className={isMobile ? "absolute top-1/2 left-1/2 w-20 h-20 bg-[#E8E4D9]/25 rounded-full blur" : "absolute top-1/2 left-1/2 w-20 h-20 bg-[#E8E4D9]/25 rounded-full blur-xl"}
        animate={{
          scale: [1, 1.1, 1],
          opacity: [0.4, 0.7, 0.4],
        }}
