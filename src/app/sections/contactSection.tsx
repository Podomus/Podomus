...
const ContactSection = () => {
  ...
  return (
    <section
      className="relative mx-auto flex w-full max-w-7xl flex-col items-center justify-center py-0 sm:py-0 lg:flex-row lg:py-0 xl:max-w-[1380px] overflow-hidden"
      style={{
        background: '#F8FAFC'
      }}
      ref={ref}
