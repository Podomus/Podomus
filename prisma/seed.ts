...
async function main() {
  console.log('🌱 Seed script - Utilisez le script create-admin-with-better-auth.js à la place')
  console.log('📝 Ce script ne crée plus d\'utilisateur manuellement')
  console.log('🔧 Utilisez: node scripts/create-admin-with-better-auth.js')
